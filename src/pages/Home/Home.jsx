    ...
    >
      <div className="home-container">
        <div className="title" ref={(el) => (title = el)}>
          <h1>
            Hi , I'm <span>Ahmed El Meskyny</span> , a web developer and a Data
            Science and Cloud Computing engineering student{" "}
          </h1>
      ...
      <div className="social-mobile" ref={(el) => (social = el)}>
        ...
        <div>
          <a
            href="https://www.linkedin.com/in/ahmed-el-b570041b5/"
            target="_blank"
            style={{ color: "black" }}
          >
